...
public class PlayListActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String order = ItemColumns.STATUS + " ASC, " + ItemColumns.CREATED + " DESC";

        Cursor cursor = managedQuery(getIntent().getData(), PROJECTION, where, null ,order);
...
*/                
                ...
                Uri delUri = ContentUris.withAppendedId(getIntent().getData(), info.id);
            ...
            case MENU_ITEM_KEEP: {
    			FeedItem feed_item = new FeedItem(getContentResolver(),info.id);
    			if( (feed_item!=null) &&(feed_item.status!=ItemColumns.ITEM_STATUS_KEEP)){
